@section('style')
    ...
    <link href="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}"  data-turbolinks-eval="false" data-turbo-eval="false" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <script src="{{ asset('js/crud/sales/omset/statistic.js') }}"></script>
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column w-100 mt-12">
                            <span class="text-dark me-2 fw-bolder pb-3"
                              >Progress</span
                            >
                            <div class="progress h-40px w-100">
                              <div
                                class="progress-bar"
                                role="progressbar"
                                style="width: 10%; background-image:url('/download.gif');"
                                aria-valuenow="10"
                                aria-valuemin="0"
                                aria-valuemax="100"
                              ></div>
            ...
            <div class="card card-xl-stretch-50 mb-5 mb-xl-8">
                <div class="card-body p-10  overflow-hidden">
                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-4" id="target_2">
                            <!--begin::Statistics Widget 5-->
                        ...
                        <div class="col-xl-4" id="target_3">
                            <!--begin::Statistics Widget 5-->
