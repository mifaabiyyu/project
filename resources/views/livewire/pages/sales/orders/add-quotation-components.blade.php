@section('title', 'Add Sales Quotation - Sales')
    ...
    <div class="toolbar" id="kt_toolbar" wire:ignore>
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack" wire:ignore.self>
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Sales Quotation</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Add Sales Quotation</li>
                    <!--end::Item-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex flex-wrap gap-5" >
                                            <div class="mb-5 fv-row w-100 flex-md-root" >
                                                ...
                                                <!--begin::Input-->
                                                <select class="form-select customer" data-placeholder="-- Select Customer --" name="customer" id="customer" >
                                                    <option></option>
                                                    {{-- @foreach ($contractors as $item)
                                                        <option value="{{ $item->Id }}" {{ $contractor == $item->Id ? "selected" : "" }}>{{ $item->CompanyName }}</option>
                                                    @endforeach --}}
                                                </select>
