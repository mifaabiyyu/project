@section('title', 'Roles - User Management')
...
@endsection
@section('scriptCrud')
    <script src="{{ asset('js/datatable/user-management/roles/roles-table.js') }}" ></script>
    <script src="{{ asset('js/crud/user-management/roles/add.js') }}" ></script>
    <script src="{{ asset('js/crud/user-management/roles/edit.js') }}" ></script>
@endsection
            ...
            <div class="card" wire:ignore>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        @livewire('components.modal.roles.add', compact('permissions', 'permission_groups'))
                        @livewire('components.modal.roles.edit', compact('permissions', 'permission_groups'))
                        <!--end::Modal - Add task-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
