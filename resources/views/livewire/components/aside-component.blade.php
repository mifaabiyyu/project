    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <div class="menu-item  {{ request()->is('dashboard') ? 'here' : '' }} menu-accordion">
                ...
                @if (!Auth::user()->hasRole('Customer'))
                    @can('Sales.view')
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->is('sales*') ? 'here show' : '' }}">
                    ...
                    @endcan
                @else
                <div class="menu-item {{ request()->is('quotation*') ? 'here' : '' }}">
                    <a class="menu-link" href="{{ route('quotation.index') }}">
                        <span class="menu-icon">
                ...
                @endif
                <div class="menu-item {{ request()->is('users-company*') ? 'here' : '' }}">
                    <a class="menu-link" href="{{ route('users-company.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                @can('UserManagement.view')
                    <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('users-management*') ? 'here show' : '' }} menu-accordion mb-1">
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item {{ request()->routeIs('users.index') ? 'here' : '' }} menu-accordion mb-1">
                            ...
                            @if (!Auth::user()->hasRole('Customer'))
                                <div class="menu-item {{ request()->routeIs('roles.index') ? 'here' : '' }} menu-accordion">
                                ...
                                <div class="menu-item  {{ request()->routeIs('permissions.index') ? 'here' : '' }} menu-accordion" >
                ...
                @can('Master-Data.view')
                    <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('master-data*') ? 'here show' : '' }} menu-accordion">
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item {{ request()->routeIs('parameters.index') ? 'here' : '' }} menu-accordion mb-1">
                                <a class="menu-link" href="{{ route('parameters.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item {{ request()->routeIs('business.index') ? 'here' : '' }}">
                                <a class="menu-link" href="{{ route('business.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            {{-- <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('master-data/general*') ? 'here show' : '' }} menu-accordion">
                                <span class="menu-link">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('master-data/operational*') ? 'here show' : '' }} menu-accordion">
                                <span class="menu-link">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
