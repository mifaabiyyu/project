<div class="modal fade" id="edit_machine" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="machine_header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-machine-modal-action="close">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="edit_machine_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @method('PUT')
                    @csrf
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-kt-machine-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-machine-modal-action="submit">
