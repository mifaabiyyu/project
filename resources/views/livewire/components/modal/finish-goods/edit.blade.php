<div class="modal fade" id="edit_finish_goods" data-bs-backdrop="static" wire:ignore.self tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered" style="max-width :1000px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="edit_finish_goods_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Edit Finish Goods</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="edit_finish_goods_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="edit_finish_goods_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#edit_finish_goods_header" data-kt-scroll-wrappers="#edit_finish_goods_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="row">
                            <!--begin::Input group-->
                            ...
                            <div class="col-md-6 fv-row mb-7" wire:ignore>
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-control="select2" data-dropdown-parent="#edit_finish_goods" data-placeholder="--- Select Division ---" name="division" id="division" aria-label="Select example">
                                    <option ></option>
                            ...
                            <div class="col-md-6 fv-row mb-7" wire:ignore>
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-dropdown-parent="#edit_finish_goods" data-placeholder="--- Select Employee ---" name="applicant" id="applicant" aria-label="Select example">
                                    <option ></option>
                                </select>                                <!--end::Input-->
                            </div>
