<div class="modal fade" id="add_customer_card" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="add_customer_card_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Customer Card</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="add_customer_card_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="add_customer_card_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#add_customer_card_header" data-kt-scroll-wrappers="#add_customer_card_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="row">
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-dropdown-parent="#add_customer_card" name="customer" data-control="select2" data-placeholder="-- Select Company --" id="company" aria-label="Select example">
                                    <option value=""></option>
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-dropdown-parent="#add_customer_card" name="product" data-control="select2" data-placeholder="-- Select Product --" id="product" aria-label="Select example">
                                    <option value=""></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 fv-row mb-7 ">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea type="text" name="description" id="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description"></textarea>
                                <!--end::Input-->
                            </div>
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" data-kt-customer-card-modal-action="submit">
