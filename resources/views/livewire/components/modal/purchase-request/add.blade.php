<div class="modal fade" id="add_purchase_request" data-bs-backdrop="static" wire:ignore.self tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered" style="max-width :1000px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="add_purchase_request_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Purchase Request</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="add_purchase_request_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="add_purchase_request_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#add_purchase_request_header" data-kt-scroll-wrappers="#add_purchase_request_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="row">
                            <!--begin::Input group-->
                            ...
                            <div class="col-md-6 fv-row mb-7" wire:ignore>
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-control="select2" data-dropdown-parent="#add_purchase_request" data-placeholder="--- Select Division ---" name="division" id="division" aria-label="Select example">
                                    <option ></option>
                            ...
                            <div class="col-md-6 fv-row mb-7" wire:ignore>
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-control form-control-solid mb-3 mb-lg-0" data-dropdown-parent="#add_purchase_request" data-placeholder="--- Select Employee ---" name="applicant" id="applicant" aria-label="Select example">
                                    <option ></option>
                                </select>                                <!--end::Input-->
                            </div>
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="description" data-kt-autosize="true" id="description" cols="" rows="">-</textarea>
                                <!--end::Input-->
                            </div>
                            <div class="col-md-6 fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid mb-3 mb-lg-0" name="total_all" id="total_all" readonly >
                                <!--end::Input-->
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal" data-kt-add-purchase-request-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-add-purchase-request-action="submit">
    ...
    <script>
        ...
        var totalAll = () => {
            ...
            $('#total_all').val(formatRupiah(total,'Rp. '));
        }
