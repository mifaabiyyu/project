<div class="modal fade" id="add_roles" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        ...
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="add_roles_header">
                <!--begin::Modal title-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="add_roles_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="add_roles_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#add_roles_header" data-kt-scroll-wrappers="#add_roles_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <!--begin::Input group-->
