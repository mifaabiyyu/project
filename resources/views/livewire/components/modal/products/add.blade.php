    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="add_product_form" method="post" action="javascript:void(0)" class="form" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    @csrf
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="add_product_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#add_product_header" data-kt-scroll-wrappers="#add_product_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Product name" />
                            <!--end::Input-->
                        </div>
                        <div class="row">
                            <!--begin::Input group-->
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="code" id="code" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Product code" />
                                <!--end::Input-->
                            </div>
                            <div class="col-md-6 fv-row mb-7">
