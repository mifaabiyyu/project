...
<body>
    <table style="width: 100%;">
        <tr>
            <td style="border: none; width: 5%; text-align: center;"> {!! DNS2D::getBarcodeHTML(route('barcode.workOrder', base64_encode($data->code)) , 'QRCODE', 3,3) !!}</td>
            ...
            <td style="border: none; width: 70%; text-align: center;">
                <p style="font-size: 14px; font-weight: 900;  letter-spacing: 0.3px; margin: 0; text-align: right;">Tanggal : {{ date("d-m-Y", strtotime($data->planning_date));}}</p>
                <p style="font-size: 20px; font-weight: 900; padding-right:120px; letter-spacing: 0.3px; margin: 0;">WORK ORDER SHEET</p>
                <p style="font-size: 20px; font-weight: 900; padding-right:120px; letter-spacing: 0.3px; margin: 0;">PT. DWI SELO GIRI MAS</p>
            </td>
            <td colspan="2"><h2 style="margin:10px; margin-bottom: 0;"></h2></td>
            <td width="5%"><h5 style=" margin-bottom: 0;">Page 1/2</h5></td>
        </tr>
    </table>
    ...
    <table style="width: 100%;">
        <tr>
            <td><h2 style="margin:10px; margin-bottom: 0;">DESCRIPTION</h2></td>
        </tr>
    </table>
    <br>
    <table style="width: 100%;">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td colspan="2"><h2 style="margin:10px; margin-bottom: 0;"></h2></td>
            <td width="5%"><h5 style=" margin-bottom: 0;">Page 2/2</h5></td>
        </tr>
    </table>
    <hr style="color: #2958a6; margin-bottom: 0px; border-top: 1px solid #2958a6;">
    <hr style="color: #ed3338; margin-top: 2px; border-top: 1px solid #ed3338;">
    <table style="width: 100%;">
        <tr>
            <td><h2 style="margin:10px; margin-bottom: 0;">Spesification</h2></td>
        </tr>
    </table>
    <br>
    <table id="table_data" style="width: 100%;">
        <thead>
            <tr>
                <th style="height: 30px" rowspan="2">Machine</th>
                <th style="height: 30px" rowspan="2">Product</th>
                <th style="height: 30px" rowspan="2">Qty</th>
                <th style="height: 30px" rowspan="2">Total Weight</th>
                <th style="height: 30px" colspan="8">Specification</th>
            </tr>
            <tr>
                <th style="height: 30px">RPM</th>
                <th style="height: 30px">SSA</th>
                <th style="height: 30px">D-50</th>
                <th style="height: 30px">D-98</th>
                <th style="height: 30px">CIE-86</th>
                <th style="height: 30px">ISO 2470</th>
                <th style="height: 30px">Residue</th>
                <th style="height: 30px">Moisture</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($detailData as $item)
