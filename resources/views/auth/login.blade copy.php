...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Login Portal HectorApp</title>
		<meta charset="utf-8" />
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('assets/media/illustrations/sketchy-1/14.png')}}">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<a href="javascript:void(0)" class="">
						<img alt="Logo" src="{{ asset('logo3.png')}}" class="h-90px" />
                        <!-- <h4 class="text-center fw-bolder fs-4 mt-5"><S>ddsfdsf</S></h4> -->
					</a>
                    <!-- <a class="text-center btn btn-hover-scale fw-bolder fs-1 mt-3 mb-5 " style="background: linear-gradient(to right, #3a1493 0%, #9369e7 100%);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent; letter-spacing: 3px; font-weight:bolder"></a> -->
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Masuk Portal Member</h1>
								<!--end::Title-->
								<!--begin::Link-->
								<!--end::Link-->
							</div>
