...
var ProductDatatable = (function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            ...
                            row.id +
                            `" data-bs-target="#show_product" id="show-data"  class="btn btn-icon btn-bg-light btn-success btn-active-color-secondary btn-sm me-1">
                            ...
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-id="` +
                            row.id +
                            `" data-bs-target="#edit_product" id="edit-data" class="btn btn-icon btn-bg-light btn-primary btn-active-color-secondary btn-sm me-1">
                            ...
                            row.id +
                            `" data-kt-products-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
    ...
    var handleFilterDatatable = () => {
        ...
        const filterButton = document.querySelector(
            '[data-kt-products-table-filter="filter"]'
        );
        // Filter datatable on submit
        filterButton.addEventListener("click", function () {
            filterPacking = document.getElementById("packingFilter").value;
            filterStatus = $("input[id='statusFilter']:checked").val();

            if (filterPacking != null) {
                filterData.packing_type_id = filterPacking;
            }
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-products-table-filter="delete_row"]'
        );
        ...
        deleteButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                // Get customer name
                const product = parent.querySelectorAll("td")[0].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("product-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
                            success: function (response) {
                                Swal.fire({
                                    text: "You have deleted " + product + "!.",
                                    icon: "success",
                                    buttonsStyling: false,
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-products-table-filter="reset"]'
        );
