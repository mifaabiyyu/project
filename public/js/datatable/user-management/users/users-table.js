            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            <a href="javascript:void(0)"  class="btn btn-icon btn-bg-light btn-success btn-active-color-secondary btn-sm me-1">
            ...
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("user-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
