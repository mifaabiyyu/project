            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-id="` +
                            row.code +
                            `" data-bs-target="#edit_quotation" id="edit-data" class="btn btn-icon btn-bg-light btn-primary btn-active-color-secondary btn-sm me-1">
                        ...
                        <a href="javascript:void(0)" data-id="` +
                            row.code +
                            `" data-kt-quotation-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
