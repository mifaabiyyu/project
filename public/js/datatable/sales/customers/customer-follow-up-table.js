...
// Class definition
var CustomerFollowUpDataTable = (function () {
    // Shared variables
    ...
    var initDatatable = function () {
        oTable = $("#customer_follow_up_table").DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            ajax: {
                data: (d) => Object.assign(d, filterData),
                url: route("customer-follow-up-data.index"),
            },
            columns: [
                {
                    data: "schedule_date",
                    render: function (data, type) {
                        var time = moment(data).format("DD-MM-YYYY hh:mm:ss");
                        return time;
                    },
                },
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            ...
                            <a href="` +
                            route("customerFollowUp.edit", row.code) +
                            ...
                            row.id +
                            `" data-kt-customers-follow-up-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-customers-follow-up-table-filter="search"]'
        );
    ...
    var handleFilterDatatable = () => {
        ...
        const filterButton = document.querySelector(
            '[data-kt-customers-follow-up-table-filter="filter"]'
        );
        ...
        filterButton.addEventListener("click", function () {
            filterCompany = document.getElementById("customerFilter").value;
            filterStatus = $("input[id='statusFilter']:checked").val();

            if (filterCompany != null) {
                filterData.customer_id = filterCompany;
            }
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-customers-follow-up-table-filter="delete_row"]'
        );
            ...
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("customer-follow-up-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-customers-follow-up-table-filter="reset"]'
        );
...
KTUtil.onDOMContentLoaded(function () {
    CustomerFollowUpDataTable.init();
});
