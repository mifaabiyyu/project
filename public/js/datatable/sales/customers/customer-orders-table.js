...
// Class definition
var CustomerOrderDataTable = (function () {
    // Shared variables
    ...
    var initDatatable = function () {
        oTable = $("#customer_orders_table").DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            order: [[0, "desc"]],
            ajax: {
                ...
                url: route("customer-order-data.index"),
            },
            columns: [
                { data: "code" },
                {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            ...
                            <a href="` +
                            route("customerOrder.check_lab", row.id) +
                            `" target="_blank" id="detail-lab-data" class="btn btn-icon btn-bg-light btn-secondary btn-active-color-secondary btn-sm me-1">
                            ...
                            row.id +
                            `" data-kt-customer-orders-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
    ...
    var handleFilterDatatable = () => {
        ...
        const filterButton = document.querySelector(
            '[data-kt-customer-orders-table-filter="filter"]'
        );
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-customer-orders-table-filter="delete_row"]'
        );
            ...
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("customer-order-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-customer-orders-table-filter="reset"]'
        );
