...
var CustomerDataTable = (function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            <a href="` +
                            route("customer.detail", row.code) +
                            `" class="btn btn-icon btn-bg-light btn-success btn-active-color-secondary btn-sm me-1">
                            ...
                            row.id +
                            `" data-kt-customers-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-customers-table-filter="delete_row"]'
        );
        ...
        deleteButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                // Get customer name
                const customer = parent.querySelectorAll("td")[1].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("customer-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
