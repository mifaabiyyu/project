...
// Class definition
var DeliveryOrderDataTable = (function () {
    // Shared variables
    ...
    var initDatatable = function () {
        oTable = $("#delivery_orders_table").DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            ajax: {
                data: (d) => Object.assign(d, filterData),
                url: route("delivery-order-data.index"),
            },
            columns: [
                { data: "code" },
                {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            ...
                            <a href="` +
                            route("deliveryOrder.edit", row.code) +
                            ...
                            row.id +
                            `" data-kt-delivery-orders-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-delivery-orders-table-filter="search"]'
        );
    ...
    var handleFilterDatatable = () => {
        ...
        const filterButton = document.querySelector(
            '[data-kt-delivery-orders-table-filter="filter"]'
        );
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-delivery-orders-table-filter="reset"]'
        );
