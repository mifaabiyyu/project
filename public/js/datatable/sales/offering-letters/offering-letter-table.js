...
var OfferingLetter = (function () {
    ...
    var initDatatable = function () {
        oTable = $("#offering_letter_table").DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            ajax: {
                data: (d) => Object.assign(d, filterData),
                url: route("offering-letter-data.index"),
            },
            columns: [
                {
                    data: "code",
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-center flex-shrink-0">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#email_offering_letter" data-id="` +
                            row.id +
                            `" id="email-data" class="btn btn-icon btn-bg-light btn-warning btn-active-color-secondary btn-sm me-1">
                            ...
                            <a href="` +
                            route("offeringLetter.print", row.id) +
                            ...
                            row.id +
                            `" data-bs-target="#edit_offering_letter" id="edit-data" class="btn btn-icon btn-bg-light btn-primary btn-active-color-secondary btn-sm me-1">
                            ...
                            row.id +
                            `" data-kt-offering-letter-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-danger btn-active-color-secondary btn-sm">
