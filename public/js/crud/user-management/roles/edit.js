...
var KTUsersEditRoles = (function () {
    ...
    $("body").on("click", "#edit-data", function () {
        ...
        $.ajax({
            type: "GET",
            url: route("role-data.show", kode),

            success: function (response) {
                $("#headerForm").html("Edit Data Role " + response.data.name);
                $("#edit_name").val(response.data.name);

                response.role.forEach((element, index) => {
                    $("#edit_permission" + index).prop("checked", element);
                });
                    ...
                    t.preventDefault(),
                        validation &&
                            validation.validate().then(function (t) {
                                ...
                                $.ajax({
                                    type: "PUT",
                                    url: route("role-data.update", kode),
                                    contentType: false,
                                    data: formData,
                                    processData: false,
                                    success: function (response) {
