...
var businessEdit = (function () {
    const modal = document.getElementById("edit_business");
    const editForm = modal.querySelector("#edit_business_form");
    var kode = "";
    editForm.reset();
    $("body").on("click", "#edit-data", function () {
        ...
        $.ajax({
            type: "GET",
            url: route("business-data.show", kode),

            success: function (response) {
                console.log(response);
                $("#modalHeader").html("Edit business " + response.data.name);
        ...
        init: function () {
            (() => {
                ...
                const onSubmit = modal.querySelector(
                    '[data-edit-business-modal-action="submit"]'
                );
                ...
                onSubmit.addEventListener("click", (t) => {
                    t.preventDefault(),
                        validation &&
                            validation.validate().then(function (t) {
                                ...
                                $.ajax({
                                    type: "PUT",
                                    url: route("business-data.update", kode),
                                    contentType: false,
                                    data: formData,
                                    processData: false,
                                    success: function (response) {
                    ...
                    modal
                        .querySelector(
                            '[data-kt-business-modal-action="cancel"]'
                        )
                    ...
                    modal
                        .querySelector(
                            '[data-kt-business-modal-action="close"]'
                        )
                        .addEventListener("click", (t) => {
                            t.preventDefault(),
                                Swal.fire({
