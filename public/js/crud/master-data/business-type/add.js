...
var businessAdd = (function () {
    const modal = document.getElementById("add_business");
    const addForm = modal.querySelector("#add_business_form");
        ...
        init: function () {
            (() => {
                ...
                const onSubmit = modal.querySelector(
                    '[data-kt-business-modal-action="submit"]'
                );
