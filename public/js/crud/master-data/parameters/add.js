"use strict";
var KTAddParameters = (function () {
    const modal = document.getElementById("add_parameters");
    const addForm = modal.querySelector("#add_parameters_form");
