"use strict";
var KTEditCompany = (function () {
    const modal = document.getElementById("edit_companies");
    const editForm = modal.querySelector("#edit_companies_form");
    var kode = "";
    editForm.reset();
    $("body").on("click", "#edit-data", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                $("#modalHeader").html(
                    "Edit Data Company " + response.data.name
                );
                $("#edit_name").val(response.data.name);
                $("#edit_code").val(response.data.code);
                $("#edit_type").val(response.data.type);
                $("#edit_address").val(response.data.address);
                $("#edit_no_telfon").val(response.data.no_telfon);
                $("#edit_description").val(response.data.description);
                $(
                    "input[id=edit_status][value=" + response.data.status + "]"
                ).prop("checked", true);
            },
                    ...
                    t.preventDefault(),
                        validation &&
                            validation.validate().then(function (t) {
                                ...
                                $.ajax({
                                    type: "PUT",
                                    url: route("company-data.update", kode),
                                    contentType: false,
                                    data: formData,
                                    processData: false,
                                    success: function (response) {
