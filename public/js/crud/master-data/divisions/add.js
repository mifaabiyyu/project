"use strict";
var KTAddDivisions = (function () {
    const modal = document.getElementById("add_divisions");
    const addForm = modal.querySelector("#add_divisions_form");
